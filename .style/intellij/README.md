...
1. Select "New profile" and rename the new profile to "PldnStyle".

1. Under "Eclipse Java Formatter config file", import [eclipse-java-style-pldn.xml](../eclipse/eclipse-java-style-pldn.xml)

1. Select "Optimize imports" and import [pldn.importorder](../eclipse/pldn.importorder).
...
1. Add the SonarQube server (SonarCloud). Select the `pldn` organization.
